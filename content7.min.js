!function (e, t) {
        ...
        function Te(e, t, n, r, i, o) {
            return r && !r[b] && (r = Te(r)), i && !i[b] && (i = Te(i, o)), le(function (o, a, s, u) {
                var l, c, f, p = [], d = [], h = a.length, g = o || function (e, t, n) {
                    ...
                    return n;
                }(t || '*', s.nodeType ? [s] : s, []), y = !e || !o && t ? g : Ce(g, p, e, s, u), v = n ? i || (o ? e : h || r) ? [] : a : y;
                if (n && n(y, v, s, u), r) {
                ...
                if (o) {
                    if (i || e) {
                        ...
                        for (c = v.length; c--;) {
                            (f = v[c]) && (l = i ? P(o, f) : p[c]) > -1 && (o[l] = !(a[l] = f));
                        }
                    }
                } else {
                    v = Ce(v === a ? v.splice(h, v.length) : v);
    ...
    function xe(e, t, n, r, i) {
                ...
                if ('object' === x(o)) {
                    ...
                    if (/<|&#?\w+;/.test(o)) {
                        for (a = a || f.appendChild(t.createElement('div')), s = (/<([a-z][^\/\0>\x20\t\r\n\f]*)/i.exec(o) || [
                            '',
                            ''
                        ])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + b.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
                            a = a.lastChild;
                        }
        ...
        for (f.textContent = '', d = 0; o = p[d++];) {
            if (r && b.inArray(o, r) > -1) {
                ...
                if (l = re(o), a = ye(f.appendChild(o), 'script'), l && ve(a), n) {
                    for (c = 0; o = a[c++];) {
            ...
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    if (a.length) {
                        ...
                        if (a = i.call(arguments), X.set(this, t, a), r = n(this, t), this[t](), a !== (o = X.get(this, t)) || r ? X.set(this, t, false) : o = {}, a !== o) {
                            return e.stopImmediatePropagation(), e.preventDefault(), o && o.value;
                        }
                    }
                } else {
                    a.length && (X.set(this, t, { value: b.event.trigger(b.extend(a[0], b.Event.prototype), a.slice(1), this) }), e.stopImmediatePropagation());
                }
            }
    ...
    b.event = {
        ...
        dispatch: function (e) {
            var t, n, r, i, o, a, s = new Array(arguments.length), u = b.event.fix(e), l = (X.get(this, 'events') || Object.create(null))[u.type] || [], c = b.event.special[u.type] || {};
            ...
            if (u.delegateTarget = this, !c.preDispatch || false !== c.preDispatch.call(this, u)) {
                for (a = b.event.handlers.call(this, u, l), t = 0; (i = a[t++]) && !u.isPropagationStopped();) {
                    for (u.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped();) {
                        u.rnamespace && false !== o.namespace && !u.rnamespace.test(o.namespace) || (u.handleObj = o, u.data = o.data, void 0 !== (r = ((b.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && false === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
                    }
                }
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && Ee(t, 'click', we), false;
                },
                trigger: function (e) {
                    var t = this || e;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && Ee(t, 'click'), true;
                },
                _default: function (e) {
                    var t = e.target;
                    return /^(?:checkbox|radio)$/i.test(t.type) && t.click && A(t, 'input') && X.get(t, 'click') || A(t, 'a');
                }
            },
            beforeunload: {
    ...
    b.Event = function (e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && false === e.returnValue ? we : Ce, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e;
        t && b.extend(this, t);
